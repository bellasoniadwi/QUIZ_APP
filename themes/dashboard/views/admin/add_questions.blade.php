...
@section('content')
    ...
    <div class="content-wrapper">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        <a class="btn btn-info btn-sm" href="javascript:;" data-toggle="modal" data-target="#myEssay">Tambah Soal Essay</a>
                                        <a class="btn btn-info btn-sm" href="javascript:;" data-toggle="modal"
                                            data-target="#myPilgan">Tambah Soal Pilgan</a>
                                    </div>
                                </div>
                                <div class="card-body">
        ...
        <!-- Pilgan -->
        <div class="modal fade" id="myPilgan" role="dialog">
        ...
        <!-- Essay -->
        <div class="modal fade" id="myEssay" role="dialog">
          <div class="modal-dialog modal-lg">
              <!-- Modal content-->
              <div class="modal-content">
                  <div class="modal-header">
                  ...
                  <div class="modal-body">
                      <form action="{{ url('/admin/add_new_question_essay') }}" class="database_operation">
                          <div class="row">
                              <div class="col-sm-12">
                                  <div class="form-group">
                                      <label for="">Enter Question</label>
